...
前几天有个同事出去面试了，他说在 Kafka 问题上被面试官藐视了。

TS：我做了一个消息总线，简化了业务团队消息的收发，并且提供了消息管理功能。

MSG：你做的这个东西，有什么深入价值吗？

TS：目的在于封装技术的复杂度，使业务团队更加专注于业务。

MSG：这个价值并没有真实打动我，这不是很简单吗？

简单吗？

Kafka 的位移提交有哪些方式？有自动提交和手动提交。
